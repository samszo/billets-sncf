...
Le projet extrait les confirmations de réservation SNCF Connect depuis Gmail, calcule le coût réel de chaque déplacement (billet + voiture + métro + repas) et produit un rapport HTML interactif avec cumuls par mois et par année.
...
graph TD
    ...
    subgraph Scripts["Scripts d'entrée"]
    ...
    style Scripts fill:#f3e5f5,stroke:#6a1b9a
...
Récupère les mails directement depuis Gmail via l'API officielle avec OAuth 2.0.
